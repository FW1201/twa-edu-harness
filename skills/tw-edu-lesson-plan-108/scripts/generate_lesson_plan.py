...
def build_sample_data(args) -> dict:
    ...
    return {
        ...
        'competencies': [
            '國-J-B1：運用國語文表情達意，增進閱讀理解，進而提升欣賞及評析文本的能力，並能傾聽他人的需求、理解他人的觀點，達到良性的人我溝通與互動。',
            '國-J-A2：透過欣賞各類文本，培養思辨的能力，並能反思內容主題，應用於日常生活中，有效處理問題。',
            '國-J-C1：閱讀各類文本，從中培養道德觀、責任感、同理心，並能觀察生活環境，主動關懷社會，增進對公共議題的興趣。',
        ],
        'performance': [
